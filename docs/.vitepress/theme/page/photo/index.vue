...
const animate = () => {
    ...
    group.children.forEach(child => {
        ...
        // ADDED: Animate opacity towards its target value
...
const onMouseClick = () => {
    ...
    if (hoveredObject && !focusedObject && !isAnimatingBack) {
        ...
        // CHANGED: Set target opacity for animation instead of changing it directly
        group.children.forEach(child => {
...
const closeFocusedView = () => {
    if (focusedObject) {
        ...
        // CHANGED: Set target opacity to fade all images back in
        group.children.forEach(child => {
